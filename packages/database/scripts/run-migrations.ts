...
const MIGRATION_FILES = [
  ...
  "062_campaign_schedule_job_dedupe.sql",
  ...
  "073_payment_attempt_organization_scope.sql",
  "074_invoice_provider_retry_state.sql",
  ...
  "084_crm_notes_tenant_scope.sql",
  ...
  "095_payment_receipts_private.sql",
  "096_operational_integrity_ledgers.sql",
  "097_operational_rpc_hardening.sql",
  "098_refund_delivery_inventory_contracts.sql",
  "099_analytics_attribution_contract.sql",
  "099_invoice_lifecycle_state_machine.sql",
  "099_notification_privacy_lifecycle.sql",
  "099_pos_sale_commands.sql",
  "100_attribution_tenant_scope.sql",
  "100_resource_context_authorization.sql",
  "101_review_submission_safety.sql",
  "102_payment_receipts_private_bucket.sql",
  "103_payment_attempt_idempotency_constraints.sql",
  "104_storefront_profile_customer_identity.sql",
  "105_payment_attempt_paid_finalization_claim.sql",
  "106_cart_merge_commands.sql",
  "107_cms_category_canonical_identity.sql",
  "108_tracking_capability_revocations.sql",
  "109_cms_category_banner_alt.sql",
