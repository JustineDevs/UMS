...
import { fetchWorkerInventoryPage, fetchWorkerOrdersForAdmin } from "@/lib/worker-admin-bridge";
...
export default async function AdminDashboardPage({
  ...
  const [ordersResult, inventoryPage] = await Promise.all([
    fetchWorkerOrdersForAdmin(100, 0),
    fetchWorkerInventoryPage({ limit: 500, offset: 0 }),
  ]);
