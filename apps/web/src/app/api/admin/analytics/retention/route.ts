...
import { adminAnalyticsRetentionResponseSchema } from "@/lib/admin-api-contracts";
...
export async function GET(req: NextRequest) {
  ...
  try {
    const response = await proxyWorkerAdminRoute(req, "/api/admin/analytics/retention", adminAnalyticsRetentionResponseSchema);
