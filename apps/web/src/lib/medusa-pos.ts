...
function pickProductThumbnailRaw(
 ...
 * Browser `<img src>` in the unified web app needs an absolute URL to load assets from Medusa (9000).
 */
function resolvePosThumbnailUrl(
