...
const HINTS: Record<string, string> = {
  Configuration:
    "The server is missing or misreading auth environment variables. On Vercel, set NEXTAUTH_URL (exact site URL, no trailing slash), NEXTAUTH_SECRET or AUTH_SECRET, GOOGLE_CLIENT_ID, and GOOGLE_CLIENT_SECRET in Project Settings (the repo .env.local file is not deployed).",
  AccessDenied:
