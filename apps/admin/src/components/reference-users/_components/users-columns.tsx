...
import { AdminEntityCell } from "@/components/admin-console";
...
export const usersColumns: ColumnDef<UserRow>[] = [
  ...
  },
  {
    ...
    cell: ({ row }) => (
      <AdminEntityCell
        leading={<AvatarCell name={row.original.name} lastActive={row.original.lastActive} />}
      ...
      <div className="text-right">
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end">
            <DropdownMenuItem onSelect={() => { window.location.href = "/admin/users"; }}>View profile</DropdownMenuItem>
            <DropdownMenuItem onSelect={() => { window.location.href = "/admin/users"; }}>Edit user</DropdownMenuItem>
            <DropdownMenuItem onSelect={() => { window.location.href = "/admin/users"; }}>Manage team</DropdownMenuItem>
            <DropdownMenuItem onSelect={() => { window.location.href = "/admin/users"; }}>Resend invite</DropdownMenuItem>
            <DropdownMenuSeparator />
            <DropdownMenuItem variant="destructive" onSelect={() => { window.location.href = "/admin/users"; }}>
              Deactivate user
            </DropdownMenuItem>
          </DropdownMenuContent>
        </DropdownMenu>
