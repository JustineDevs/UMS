...
Same as parent `stress-test/README.md`: `ADMIN_ALLOWED_EMAILS`, `AUTH_SECRET`, `pnpm e2e:ensure-staff`, and `E2E_ADMIN_AUTH=1` for the authenticated pass through `/sign-in/e2e`.
