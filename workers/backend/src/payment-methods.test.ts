...
test("payment capabilities expose configured providers without secrets", () => {
  const response = handlePaymentMethodsRequest(new Request("https://api.test/store/payment-methods"), {
